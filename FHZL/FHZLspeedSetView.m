...
@interface FHZLspeedSetView ()<UITextFieldDelegate>
{
}
...
@implementation FHZLspeedSetView

- (id)init
{
    self = [[[NSBundle mainBundle] loadNibNamed:@"FHZLspeedSetView" owner:self options:nil] objectAtIndex:0];
