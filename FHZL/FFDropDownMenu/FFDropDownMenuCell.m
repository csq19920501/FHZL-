...
//    CGFloat labelX = CGRectGetMaxX(self.customImageView.frame) + self.iconRightMargin;
    CGFloat labelX = self.iconLeftMargin;
    self.customTitleLabel.frame = CGRectMake(labelX, 0, self.frame.size.width - labelX *2, self.frame.size.height - separaterHeight);
